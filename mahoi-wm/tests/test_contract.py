...
from mahoi.wm.controller import (PHASE_DONE, PHASE_DWELL, PHASE_TO_GOAL,
                                 PHASE_TO_WP, TeamState, initial_state)
from mahoi.wm.planner import Cost, CostWeights, Planner
from mahoi.wm.traj import Trajectory
from mahoi.wm.worldmodel import PlanMode, Rollout, WorldModel
...
def test_hard_block_is_large_but_finite():
    ...
    from mahoi.wm.planner import W_HARD
