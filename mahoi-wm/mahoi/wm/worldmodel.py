...
from .controller import (PHASE_DONE, PHASE_DWELL, PHASE_TO_GOAL, PHASE_TO_WP,
...
# --------------------------------------------------------------------------- #
class WorldModel:
    def __init__(self, problem: Problem, k_routes: int = 2,
    ...
    # -- mode set ---------------------------------------------------------- #
    def sample_modes(self, max_modes: int = 16,
