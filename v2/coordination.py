...
# `plan_coordination_multiroute`(원본 coordination.py:602-637)는 여기서 제거했다.
# 저장소 전체에서 호출부가 하나도 없는 죽은 코드였고, 유일하게 그 함수만 쓰던
# `VisibilityGraph` / `build_route_options` import 도 같이 걷어냈다.
